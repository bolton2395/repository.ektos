...
@plugin.route('/')
def root():
    categories = {"01": "[COLOR lime]UK & USA Channels[/COLOR]",
                  "02": "[COLOR lime]Movies[/COLOR]",
                  "03": "[COLOR lime]Music[/COLOR]",
                  "04": "[COLOR lime]News[/COLOR]",
                  "05": "[COLOR lime]Sport[/COLOR]",
                  "06": "[COLOR lime]Documentary[/COLOR]",
                  "07": "[COLOR lime]Kids[/COLOR]"}
